...
Веб-приложение для просмотра экспортированных сессий чата с AI (Google Gemini и подобных) в форматах JSON и JSONL.
...
- **Сворачивание ответов AI** — длинные ответы Gemini можно скрывать/показывать
